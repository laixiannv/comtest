 ...
 */
 class Order {
    ...
    private String confirmationNumber;//此编号表示通过中央预订系统或酒店普通预订生成的确认号
    ...
    private String name;//证件姓名
     ...
     public Order(String appId, String IMEI, String hotelId, String confirmationNumber, String OTANumber, String phoneNumber, String lastName, String firstName, String documentNumber, String name) {
